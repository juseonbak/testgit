...
MODULE OMSAO_indices_module
  ...
  !     ops: scaling parameter for OMPS slit function
  ! --------------------------
  INTEGER, PARAMETER :: &
  ...
  INTEGER, PARAMETER :: maxalb = 12, maxwfc = 12, maxoth = 4, maxgrp = 8, maxcldaer=8
